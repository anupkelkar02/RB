...
public class InterestRecFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_interest_rec, container, false);
    ...
    private ArrayList<Dataobject> getDataSet() {
        ...
        for (int index = 0; index < 20; index++) {
            Dataobject obj = new Dataobject("Dipeka Kharote","test",R.drawable.profile_image,R.drawable.ic_list_massage,R.drawable.ic_list_star,R.drawable.interested_not_btn);
