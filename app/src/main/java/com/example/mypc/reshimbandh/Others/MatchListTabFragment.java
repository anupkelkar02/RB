...
public class MatchListTabFragment extends Fragment {
    ...
    class MyAdapter extends FragmentPagerAdapter {
        ...
        {
            switch (position){
                case 0 : return new MatchesFragment();
                case 1 : return new NewMatchesFragment();
                case 2 : return new ShortListedFragment();
                case 3 : return new ShortListedFragment();
                case 4 : return new ShortListedFragment();
            }
            return null;
        }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position){
                ...
                case 2 :
                    return "REDCOMMEDED MATCH LIST";
                case 3 :
                    return "GENRAL MATCH LIST";
                case 4 :
                    return "GENRAL LIST";
            }
            return null;
